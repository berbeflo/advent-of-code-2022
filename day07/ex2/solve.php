...
$neededSpace = 30000000 - (70000000 - $root->getSize());

$bigDirectories = [];
findBigDirectories($root, $bigDirectories, $neededSpace);

usort($bigDirectories, function ($left, $right) {
    return $left->getSize() <=> $right->getSize();
});

echo $bigDirectories[0]->getSize();
